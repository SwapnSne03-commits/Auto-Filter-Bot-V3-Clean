...
ɪ ᴀᴍ ᴛʜᴇ ᴍᴏꜱᴛ ᴘᴏᴡᴇʀꜰᴜʟʟ & ᴀᴅᴠᴀɴᴄᴇᴅ ᴍᴇᴅɪᴀ ᴘʀᴏᴠɪᴅᴇʀ ʙᴏᴛ.\n\n⚡ Commands:\n• /help → ɢᴜɪᴅᴇ ᴛᴏ sᴇᴀʀᴄʜ ᴍᴏᴠɪᴇs/sᴇʀɪᴇs ᴜsɪɴɢ ᴍᴇ.\n• /request → ʀᴇǫᴜᴇsᴛ ʏᴏᴜʀ ᴍᴏᴠɪᴇ/sᴇʀɪᴇs ᴛᴏ ᴀᴅᴍɪɴs.</b>"""
...
👇 ꜱᴛᴇᴘꜱ ᴛᴏ ᴠᴇʀɪꜰʏ:
1️⃣ ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴs.
2️⃣ ᴊᴏɪɴ ᴀʟʟ ᴛʜᴇ ᴄʜᴀɴɴᴇʟs.
...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇǫᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    CUDNT_FND = """<b>{} ɪ ᴄᴏᴜʟᴅɴ'ᴛ ꜰɪɴᴅ ᴀɴʏᴛʜɪɴɢ ʀᴇʟᴀᴛᴇᴅ ᴛᴏ ᴛʜᴀᴛ,
ᴅɪᴅ ʏᴏᴜ ᴍᴇᴀɴ ᴀɴʏ ᴏɴᴇ ᴏꜰ ᴛʜᴇꜱᴇ ?</b>"""

    I_CUDNT = """<b>sᴏʀʀʏ !! ɪ ᴄᴏᴜʟᴅɴ'ᴛ ғᴏᴜɴᴅ ᴀɴʏᴛʜɪɴɢ.🤐
...
🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./).</b>"""
    ...
    MVE_NT_FND = """<b>ɪ ᴄᴏᴜʟᴅɴ'ᴛ ғᴏᴜɴᴅ ᴀɴʏᴛʜɪɴɢ.🤐
ɪᴛ ʜᴀꜱ ᴇɪᴛʜᴇʀ ɴᴏᴛ ʙᴇᴇɴ ʀᴇʟᴇᴀꜱᴇᴅ ᴏʀ ʜᴀꜱ ɴᴏᴛ ʏᴇᴛ ʙᴇᴇɴ ᴀᴅᴅᴇᴅ ᴛᴏ ᴍʏ ᴅᴀᴛᴀʙᴀꜱᴇ.👀

ᴅᴏɴ'ᴛ ᴡᴏʀʀʏ! ʏᴏᴜ ᴄᴀɴ sᴇɴᴅ ᴛʜᴇ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴍʏ ᴀᴅᴍɪɴs 👇.</b>"""
...
Mᴇꜱꜱᴀɢᴇ : <code>{}</code>"""
    ...
    CAPTION = """<b>{file_caption}\n\n{metadata}\n\nᴊᴏɪɴ ᴜs: <a href="https://t.me/graduate_movies">[@Graduate_Movies]</a></b>"""
...
🛠️ ʙᴜɪʟᴅ ꜱᴛᴀᴛᴜꜱ : <code>V5.0 [ ꜱᴛᴀʙʟᴇ ]</code>
</b>"""
    LOGO = """
  ____   ___   __  __ 
/ ___| / _ \ |  \/  |
...
> S O M   B O T   S Y S T E M <

𝙱𝙾𝚃 𝙸𝚂 𝚄𝙿 𝙰𝙽𝙳 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 𝙿𝚁𝙾𝙿𝙴𝚁𝙻𝚈"""
