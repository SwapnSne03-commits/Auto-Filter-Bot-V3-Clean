...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003834489775'))  
...
SUPPORT_GRP = environ.get('SUPPORT_GRP', 'https://t.me/Graduate_Request')
